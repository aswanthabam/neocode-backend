...
from sharing.views import (
    QRCodeShareViewSet,
    ShareSessionViewSet,
    SharingActivityViewSet,
    DocumentRequestResponseViewSet,
    ShareNotificationViewSet,
    QRCodeAccessView,
    ShareStatsView,
    BulkShareView,
)
...
router.register(
    r"documents/categories", DocumentCategoryViewSet, basename="document-category"
)
router.register(r"documents", DocumentViewSet, basename="document")
router.register(r"documents/access", DocumentAccessViewSet, basename="document-access")
router.register(
    r"documents/access-logs", DocumentAccessLogViewSet, basename="document-access-log"
)
router.register(r"sharing/requests", DocumentShareViewSet, basename="document-share")
router.register(
    r"sharing/requests", DocumentRequestViewSet, basename="document-request"
)
...
router.register(
    r"sharing/activities", SharingActivityViewSet, basename="sharing-activity"
)
router.register(
    r"sharing/responses",
    DocumentRequestResponseViewSet,
    basename="document-request-response",
)
router.register(
    r"sharing/notifications", ShareNotificationViewSet, basename="share-notification"
)
        ...
        include(
            [
                ...
                path(
                    ...
                    UserSecuritySettingsView.as_view(),
                    name="security-settings",
                ),
                path(
                    "auth/security/verify-pin/",
                    PINVerificationView.as_view(),
